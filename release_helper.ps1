# Release Helper Script for RustyPing v2.4.2
# Run this script in PowerShell to build and prepare for release.

$ErrorActionPreference = "Stop"

Write-Host "🚀 Starting Release Process for v2.4.2..." -ForegroundColor Cyan
...
Write-Host "2. git commit -m 'chore: release v2.4.2'" -ForegroundColor Yellow
Write-Host "3. git tag -a v2.4.2 -m 'Release v2.4.2'" -ForegroundColor Yellow
...
Write-Host "2. Select Tag: v2.4.2" -ForegroundColor White
Write-Host "3. Title: v2.4.2 - Deep Diagnostics & Hotfixes" -ForegroundColor White
